...
.run(function($ionicPlatform, $cordovaSQLite,$ionicLoading, $location, $ionicHistory) {
  ...
  $ionicPlatform.ready(function() 
  {
   ...
   // }
	...
	//db = $cordovaSQLite.openDB("consumo.db");
    $cordovaSQLite.execute(db, "CREATE TABLE IF NOT EXISTS consumos (id integer primary key, fecha_consumo text, kilometraje integer,monto_consumo numeric,galones_consumo numeric,precio_galon numeric )");
